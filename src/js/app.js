...
function themeOne() {body.style.setProperty('--accent', 'rgb(0, 200, 255)');}
function themeTwo() {body.style.setProperty('--accent', 'rgb(255, 200, 0)');}
function themeThree() {body.style.setProperty('--accent', 'rgb(255, 0, 50)');}
function themeFour() {body.style.setProperty('--accent', 'rgb(0, 255, 100)');}
function themeFive() {body.style.setProperty('--accent', 'rgb(150, 0, 255)');}
